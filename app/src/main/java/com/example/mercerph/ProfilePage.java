            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (id)
                {
                    ...
                    case R.id.about:
                        ...
                        break;
                    case R.id.catalog:
                        startActivity(new Intent(ProfilePage.this,CatalogPage.class));
                        break;
                    case R.id.logout:
                        Paper.book().destroy();

                        Intent intent = new Intent(ProfilePage.this, MainActivity.class); //sends the user to the Homepage of the App
